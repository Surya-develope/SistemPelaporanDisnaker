...
Route::middleware(['web', \App\Http\Middleware\RoleMiddleware::class . ':admin,lattas'])->prefix('lattas')->group(function () {
    ...
    Route::get('/pelatihan/template', [LattasController::class , 'templatePelatihan'])->name('lattas.template.pelatihan');
    ...
    Route::get('/lpk/template', [LattasController::class , 'templateLpk'])->name('lattas.template.lpk');
    ...
    Route::prefix('import')->group(function () {
        ...
        // Bulk Delete Data Lattas
        Route::delete('/lpk/bulk-delete/all', [LattasController::class , 'bulkDeleteLpk'])->name('lattas.bulk-delete.lpk');
        Route::delete('/training/bulk-delete/all', [LattasController::class , 'bulkDeleteTraining'])->name('lattas.bulk-delete.training');

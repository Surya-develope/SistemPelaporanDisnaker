...
<div class="card shadow p-3 mb-4">
    <form method="GET" action="{{ url('/penta/tenaga-kerja') }}" class="row g-3 align-items-end">
        ...
        <div class="col-md-auto ms-auto">
            <a href="{{ route('penta.export.tenaga-kerja', ['bulan' => request('bulan'), 'tahun' => request('tahun')]) }}" class="btn btn-success">
...
<div class="card card-modern shadow-sm p-4">
    <div class="d-flex justify-content-between mb-3">
        ...
        <div>
            <button type="button" class="btn btn-success btn-sm me-2" data-bs-toggle="modal" data-bs-target="#tambahPencariModal">

...
<div class="import-page">
    ...
    {{-- ── CARD 2: Pelatihan LPK ── --}}
    <div class="import-card">
        <div class="import-card-header">
            <div class="icon-wrap"><i class="fa-solid fa-graduation-cap"></i></div>
            <div>
                <h6>Import Rekap Pelatihan LPK</h6>
                <small>Data program pelatihan dan jumlah peserta per lembaga</small>
            </div>
        </div>
        <div class="import-card-body">
            <div class="format-hint">
            ...
            <form action="{{ route('lattas.import.training') }}" method="POST" enctype="multipart/form-data">
                ...
                <input type="file" name="file" class="form-control" required accept=".xls,.xlsx,.csv">
                <button class="btn-import" type="submit">
                    <i class="fa-solid fa-upload"></i> Import Pelatihan LPK
                </button>
            </form>
        </div>
    </div>

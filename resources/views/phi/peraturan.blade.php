...
<h4 class="mb-4">Bidang PHI - Rekap Peraturan Perusahaan</h4>
...
<div class="card card-modern p-4 shadow-sm">
    <div class="d-flex justify-content-between mb-3 align-items-center">
        ...
        <div class="d-flex gap-2">
            <button class="btn btn-success shadow-sm" data-bs-toggle="modal" data-bs-target="#modalImportPeraturan">
            ...
            <form action="{{ route('phi.import.peraturan') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-info py-2">
                        ...
                        <a href="{{ route('phi.template.peraturan') }}" class="d-block mt-2 fw-bold text-success border-bottom border-success" style="width: fit-content;"><i class="fa fa-download me-1"></i> Download Template</a>
                    </div>
                </div>
